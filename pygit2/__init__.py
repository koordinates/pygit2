...
GIT_REPOSITORY_STATE_CHERRYPICK_SEQUENCE: int = (
    C.GIT_REPOSITORY_STATE_CHERRYPICK_SEQUENCE
)
...
GIT_INDEX_WRITE_TREE_DEFAULT = C.GIT_INDEX_WRITE_TREE_DEFAULT
GIT_INDEX_WRITE_TREE_VALIDATE_OIDS = C.GIT_INDEX_WRITE_TREE_VALIDATE_OIDS

# GIT_MEMPACK
GIT_MEMPACK_DEFAULT = C.GIT_MEMPACK_DEFAULT
GIT_MEMPACK_GROUP_BY_COMMIT = C.GIT_MEMPACK_GROUP_BY_COMMIT

# GIT_ODB
GIT_ODB_LOOKUP_NO_REFRESH = C.GIT_ODB_LOOKUP_NO_REFRESH
...
def init_repository(
    ...
    *origin_url* are all strings.
    ...
    C.git_repository_init_options_init(options, GIT_REPOSITORY_INIT_OPTIONS_VERSION)
    options.flags = flags
    options.mode = mode
